...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_images_path', type=str, default="/kaggle/input/euvp-dataset/EUVP/Paired/underwater_dark/trainA/", help='path of input images(underwater images) for testing default:./data/input/')
    ...
    parser.add_argument('--label_images_path', type=str, default="/kaggle/input/euvp-dataset/EUVP/Paired/underwater_dark/trainB/", help='path of label images(clear images) default:./data/label/')
